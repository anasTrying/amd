/* =========================================================================
   ...
   location → إحداثيات نقطة البيع للفرع المعروض في العملية (قيم تجريبية
   للعرض)؛ null تعني عملية إلكترونية بدون نقطة بيع فعلية.
   ========================================================================= */
...
const WATHQ_MERCHANTS = [
  ...
  /* ---------- سجلات حقيقية من واثق (بيئة الإنتاج) ---------- */
  {
    ...
    categoryLabel: "مقاهي",
    location: { lat: 24.6995, lng: 46.6849, branchLabel: "فرع شارع التحلية — العليا", address: "شارع الأمير محمد بن عبدالعزيز (التحلية)، حي العليا، الرياض" },
  ...
  },
  {
    ...
    location: { lat: 24.6877, lng: 46.7219, branchLabel: "فرع شارع العليا العام", address: "شارع العليا العام، حي المروج، الرياض" },
  ...
  },
  {
    ...
    location: { lat: 24.7508, lng: 46.6512, branchLabel: "محطة طريق الملك فهد", address: "طريق الملك فهد، حي المحمدية، الرياض" },
  ...
  },
  {
    ...
    location: { lat: 24.8232, lng: 46.6366, branchLabel: "فرع حي الياسمين", address: "طريق أنس بن مالك، حي الياسمين، الرياض" },
